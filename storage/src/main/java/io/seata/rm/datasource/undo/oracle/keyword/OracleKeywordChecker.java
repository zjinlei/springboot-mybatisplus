...
public class OracleKeywordChecker implements KeywordChecker {
    ...
    public static KeywordChecker getInstance() {
        if (keywordChecker == null) {
            synchronized (io.seata.rm.datasource.undo.oracle.keyword.OracleKeywordChecker.class) {
                if (keywordChecker == null) {
                    keywordChecker = new io.seata.rm.datasource.undo.oracle.keyword.OracleKeywordChecker();
