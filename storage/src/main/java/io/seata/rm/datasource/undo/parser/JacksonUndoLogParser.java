 ...
 * @author jsbxyyx
 */
@LoadLevel(name = io.seata.rm.datasource.undo.parser.JacksonUndoLogParser.NAME)
public class JacksonUndoLogParser implements UndoLogParser {

    public static final String NAME = "jackson";

    private static final Logger LOGGER = LoggerFactory.getLogger(io.seata.rm.datasource.undo.parser.JacksonUndoLogParser.class);
