...
public class TableRecords {
     ...
     */
    public static io.seata.rm.datasource.sql.struct.TableRecords empty(TableMeta tableMeta) {
     ...
     */
    public static io.seata.rm.datasource.sql.struct.TableRecords buildRecords(TableMeta tmeta, ResultSet resultSet) throws SQLException {
        io.seata.rm.datasource.sql.struct.TableRecords records = new io.seata.rm.datasource.sql.struct.TableRecords(tmeta);
    ...
    public static class EmptyTableRecords extends io.seata.rm.datasource.sql.struct.TableRecords {
