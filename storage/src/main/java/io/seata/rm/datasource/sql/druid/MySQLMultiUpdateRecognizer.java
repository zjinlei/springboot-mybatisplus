 ...
 * @author sharajava
 */
public class MySQLMultiUpdateRecognizer extends BaseMySQLRecognizer implements SQLUpdateRecognizer {
     ...
     * @param ast         the ast
     */
    public MySQLMultiUpdateRecognizer(String originalSQL, SQLStatement ast) {
        super(originalSQL);
