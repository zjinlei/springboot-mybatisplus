...
public class IndexMeta {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof io.seata.rm.datasource.sql.struct.IndexMeta)) {
            return false;
        }
        io.seata.rm.datasource.sql.struct.IndexMeta indexMeta = (io.seata.rm.datasource.sql.struct.IndexMeta) o;
