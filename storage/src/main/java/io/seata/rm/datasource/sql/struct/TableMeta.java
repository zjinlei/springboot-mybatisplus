...
public class TableMeta {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof io.seata.rm.datasource.sql.struct.TableMeta)) {
            return false;
        }
        io.seata.rm.datasource.sql.struct.TableMeta tableMeta = (io.seata.rm.datasource.sql.struct.TableMeta) o;
