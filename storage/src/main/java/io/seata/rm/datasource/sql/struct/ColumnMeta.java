...
public class ColumnMeta {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof io.seata.rm.datasource.sql.struct.ColumnMeta)) {
            return false;
        }
        io.seata.rm.datasource.sql.struct.ColumnMeta columnMeta = (io.seata.rm.datasource.sql.struct.ColumnMeta) o;
