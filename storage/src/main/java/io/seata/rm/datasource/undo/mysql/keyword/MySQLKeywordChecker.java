...
public class MySQLKeywordChecker implements KeywordChecker {
    ...
    public static KeywordChecker getInstance() {
        if (keywordChecker == null) {
            synchronized (io.seata.rm.datasource.undo.mysql.keyword.MySQLKeywordChecker.class) {
                if (keywordChecker == null) {
                    keywordChecker = new io.seata.rm.datasource.undo.mysql.keyword.MySQLKeywordChecker();
