...
public class DataSourceProxy extends AbstractDataSourceProxy implements Resource {
    ...
    private static final Logger logger = LoggerFactory.getLogger(io.seata.rm.datasource.DataSourceProxy.class);
    ...
    private void init(DataSource dataSource, String resourceGroupId) {
        ...
        tableMetaExcutor.scheduleAtFixedRate(new Runnable() {
            @Override
            public void run() {
                TableMetaCache.refresh(io.seata.rm.datasource.DataSourceProxy.this);
            }
